...
This website uses the link:https://cryogenweb.org/index.html[Cryogen static site generator], which is written in Clojure, to do much of the templating and blog structures. Additionally all of the pages and blogposts are written in AsciiDoc, an alternative to MarkDown, which I did as a challenge to learn a new way to learn a new way of simple typesetting.
