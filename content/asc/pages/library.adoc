...
I enjoyed the ordering of the material in this book, which is evidently the wrong way. I would highly reccomend this as a first book for many topics in linear algebra.
====
--
...
Of what I read, this book had well done exposition, although it was tailored to the computer scientist. Some of the more intensive proofs were left out, but nothing had a significant reliance on anything left unproven. I would highly reccomend this book as an introduction to finite automata and turing machines.
====
--
* {empty}
+
...
This book serves as a better introduction to computer architecture than its cousin, but covers fewer advanced topics. I would definitely reccomend reading this book first if you are unfamiliar with the topics.
====
--
* {empty}
+
...
I have heard great reviews from trusted about this book, so I would highly reccomend it if you are interested in the topics inside.
====
--
